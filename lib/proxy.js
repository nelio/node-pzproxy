...
function proxyRequest(req,res,hostOrURL,port,opts,callback){
    ...
    if ( _opts.timeout ) {
        timeout = setTimeout(function(){
            ...
            res.answer(502,{'Content-type':'text/plain; charset=UTF-8'},'502 - Gateway timeout :-(');
        },_opts.timeout);
    }
    ...
    preq.on('error',function(e){
        ...
        return callback ? callback(null,req,res,preq,null,{docSize: msg.length, flags: ['E']}) : null;
    });
